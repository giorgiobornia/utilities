...
if ( t < 3 )     { int b_1 =     main(-86, 0, a+1 ) + a;
 ...
 int mainmin94 = main(-94, -27 + t, a );
     ...
     if ( mainmin94 && t == 2 && b < 13)  { return_int = main(2, b+1, "%s %d %d\n" ); } //it stays here and increases b until b == 13
else if ( mainmin94 && t == 2 && b >= 13) { return_int = 9;  }
else                                      { return_int = 16; }

// return_int = ( a_1, a_2, a_3 );  /*What is this operation? Evaluate the first operand, then discard the result, then evaluate the second operand, ...*/
